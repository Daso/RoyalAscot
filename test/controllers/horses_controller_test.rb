...
class HorsesControllerTest < ActionController::TestCase
  ...
  test "should create horse" do
    assert_difference('Horse.count') do
      post :create, horse: { name: @horse.name, place: @horse.place, ratio: @horse.ratio, wins: @horse.wins }
    end
  ...
  test "should update horse" do
    patch :update, id: @horse, horse: { name: @horse.name, place: @horse.place, ratio: @horse.ratio, wins: @horse.wins }
    assert_redirected_to horse_path(assigns(:horse))
  end
